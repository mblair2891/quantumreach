...
export const workspaceNavigation: NavSection[] = [
 ...
 { heading: "OUTREACH", items: [{label:"Imports",href:"/dashboard/imports",icon:Users},{label:"Campaigns",href:"/dashboard/campaigns",icon:Mail},{label:"Email Sequences",href:"/dashboard/email-sequences",icon:Mail},{label:"Cold outreach",href:"/dashboard/sending/outbound",icon:Mail},{label:"Outreach campaigns",href:"/dashboard/sending/outbound/campaigns",icon:Mail},{label:"Sending Domains",href:"/dashboard/sending/domains",icon:Globe2},{label:"Mailboxes",href:"/dashboard/sending/mailboxes",icon:Mail},{label:"Sender Identities",href:"/dashboard/sending/senders",icon:Mail},{label:"Deliverability",href:"/dashboard/sending/deliverability",icon:BarChart3}] },
