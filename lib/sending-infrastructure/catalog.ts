...
export const ENTITLEMENT_KEYS = {
  ...
  TEAM_USER_ALLOWANCE: "TEAM_USER_ALLOWANCE",
  STORAGE_GB_ALLOWANCE: "STORAGE_GB_ALLOWANCE",
  DAILY_MAILBOX_CAPACITY: "DAILY_MAILBOX_CAPACITY",
  DAILY_DOMAIN_CAPACITY: "DAILY_DOMAIN_CAPACITY",
  COMPLETE_PLATFORM_INCLUDED: "COMPLETE_PLATFORM_INCLUDED",
...
export const DEFAULT_COMMERCE_CATALOG: CatalogProduct[] = [
  ...
  { key: COMMERCE_PRODUCT_KEYS.LAUNCH, name: "Launch", category: "SENDING_PACKAGE", active: true, recurring: true, sortOrder: 30, entitlements: { [ENTITLEMENT_KEYS.MANAGED_DOMAIN_ALLOWANCE]: 2, [ENTITLEMENT_KEYS.MAILBOX_ALLOWANCE]: 6, [ENTITLEMENT_KEYS.SENDER_IDENTITY_ALLOWANCE]: 6, [ENTITLEMENT_KEYS.MONTHLY_SEND_ALLOWANCE]: 4500, [ENTITLEMENT_KEYS.ACTIVE_OUTREACH_CONTACT_ALLOWANCE]: 5000, [ENTITLEMENT_KEYS.TEAM_USER_ALLOWANCE]: 2, [ENTITLEMENT_KEYS.COMPLETE_PLATFORM_INCLUDED]: true } },
  { key: COMMERCE_PRODUCT_KEYS.GROWTH, name: "Growth", category: "SENDING_PACKAGE", active: true, recurring: true, sortOrder: 40, entitlements: { [ENTITLEMENT_KEYS.MANAGED_DOMAIN_ALLOWANCE]: 5, [ENTITLEMENT_KEYS.MAILBOX_ALLOWANCE]: 15, [ENTITLEMENT_KEYS.SENDER_IDENTITY_ALLOWANCE]: 15, [ENTITLEMENT_KEYS.MONTHLY_SEND_ALLOWANCE]: 11500, [ENTITLEMENT_KEYS.ACTIVE_OUTREACH_CONTACT_ALLOWANCE]: 25000, [ENTITLEMENT_KEYS.TEAM_USER_ALLOWANCE]: 5, [ENTITLEMENT_KEYS.COMPLETE_PLATFORM_INCLUDED]: true } },
  { key: COMMERCE_PRODUCT_KEYS.SCALE, name: "Scale", category: "SENDING_PACKAGE", active: true, recurring: true, sortOrder: 50, entitlements: { [ENTITLEMENT_KEYS.MANAGED_DOMAIN_ALLOWANCE]: 10, [ENTITLEMENT_KEYS.MAILBOX_ALLOWANCE]: 30, [ENTITLEMENT_KEYS.SENDER_IDENTITY_ALLOWANCE]: 30, [ENTITLEMENT_KEYS.MONTHLY_SEND_ALLOWANCE]: 23000, [ENTITLEMENT_KEYS.ACTIVE_OUTREACH_CONTACT_ALLOWANCE]: 100000, [ENTITLEMENT_KEYS.TEAM_USER_ALLOWANCE]: 10, [ENTITLEMENT_KEYS.COMPLETE_PLATFORM_INCLUDED]: true } },
