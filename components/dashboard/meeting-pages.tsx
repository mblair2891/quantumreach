...
import { LocalRecordingUpload } from "@/components/meetings/local-recording-upload";
...
function durationText(startedAt?: Date | null, endedAt?: Date | null) {
  if (!startedAt || !endedAt) return startedAt && !endedAt ? "In progress" : "End time unavailable";
