...
const exploreActions = [
  ...
  ["Manage clients", "/dashboard/projects"],
] as const;
...
export function SaasDashboard({ workspaceName, snapshot, journey, createExample, requiredSetupComplete }: { workspaceName: string; snapshot: DashboardSnapshot; journey: { nextAction: JourneyAction; completed: number; total: number } | null; createExample: () => Promise<void>; requiredSetupComplete: boolean }) {
