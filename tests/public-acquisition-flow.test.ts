...
describe("public acquisition flow", () => {
  ...
  it("shows active core catalog products before authentication", () => { const text = source("app/start/page.tsx"); expect(text).toContain('category: "SOFTWARE_CORE", active: true'); expect(text).not.toContain("/sign-up"); });
