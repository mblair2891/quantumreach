...
export async function POST() {
  ...
  return NextResponse.json({ error: "Stripe checkout wiring is ready, but the Stripe SDK is intentionally deferred until billing is enabled for private beta." }, { status: 501 });
}
