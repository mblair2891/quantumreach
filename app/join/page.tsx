...
function Summary({ label, value }: { label: string; value: string }) { return <div><span className="text-sm text-slate-700">{label}</span><p className="font-semibold text-slate-950">{value}</p></div>; }
